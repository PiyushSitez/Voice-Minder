...
const dictionary: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    perm_enable_notif: "Enable Background Alerts",
    perm_wakelock_active: "Screen Wake Lock Active",
    notif_modal_title: "Enable Notifications",
    notif_modal_desc: "Don't miss a beat! Allow notifications to receive reminders even when your device is locked.",
    notif_modal_allow: "Allow Notifications",
    notif_modal_deny: "Maybe Later",
  ...
  hi: {
    ...
    frm_category: "श्रेणी",
    frm_recurrence: "पुनरावृत्ति",
    frm_volume: "आवाज़ स्तर",
    rec_none: "दोहराना नहीं",
    rec_daily: "दैनिक",
    ...
    // Notifications & Permissions
    perm_enable_notif: "पृष्ठभूमि अलर्ट सक्षम करें",
    perm_wakelock_active: "स्क्रीन सक्रिय (Wake Lock)",
    notif_modal_title: "नोटिफिकेशन चालू करें",
    notif_modal_desc: "कोई भी रिमाइंडर न चूकें! डिवाइस लॉक होने पर भी रिमाइंडर प्राप्त करने के लिए नोटिफिकेशन की अनुमति दें।",
    notif_modal_allow: "अनुमति दें",
    notif_modal_deny: "बाद में",
