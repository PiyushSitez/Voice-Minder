  ...
  return (
    <div className="max-w-6xl mx-auto mt-6 animate-in fade-in slide-in-from-bottom-5 duration-500">
      <div className="flex items-center gap-4 mb-8">
         ...
         <h1 className="text-3xl font-bold text-white">{t('check_title')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">{plan.type} Plan</span></h1>
      </div>
